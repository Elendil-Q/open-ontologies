...
not say what a repeated binding key meant, or what an incomplete binding meant, so each kernel
answered from whatever its lookup function happened to do. That gap is closed by
